//housing 
var housingBarriersReason = echarts.init(document.getElementById('housReasons'));
var housingOptions0 = {
	title: {
        text: 'Housing Barriers Broken Down by Reason',
		x: 'center'
    },
    tooltip: {
        trigger: 'axis',
    ...
    series: [
        {
            ...
            data: [
				...
				{value:6, name:'Did not know where to get it'},
				{value:14, name:'Too long of a wait '},
				{value:9, name:'Service not available'},
				{value:9, name:'Did not qualify'},
				...
				{value:2, name:'Discrimination because of sexual orientation'},
				{value:1, name:'Discrimination because of gender'},
				{value:4, name:'I was not in stable living condition'},
				{value:8, name:'Nervous or afraid of what people might say'},
				{value:6, name:'Stigma due to HIV'},
				{value:4, name:'Discrimination because of my HIV status'}
				],
...
//top barrier too long of a wait
 ...
 housingBarriersReason.setOption(housingOptions0);
